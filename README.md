...
- Discuss: This is a generic AI assistant, but tuned to hellp you with studies. THe reason for adding this feature is, the user can tag a card to the chat and ask about it. And most important the model has three levels of context awareness:
