    ...
    *,
    ...
    parts.extend(
        [
            ...
            "- For medium or long explanatory answers, start with a short direct paragraph, then use ## section headings with focused paragraphs or bullets.",
            "- Do not begin with a # title or turn the first sentence into a heading.",
            "- For bullets, prefer a bold lead-in followed by a short dash explanation, like: - **Core idea** - clear explanation.",
            ...
            "- Use > blockquotes sparingly for one important note, definition, or takeaway that deserves visual emphasis.",
            "- Do not invent generated/read-time metadata unless the user or app context actually provides it.",
            "- Do not end with offers or follow-up questions like 'Do you want me to break this down further?' Just complete the breakdown.",
